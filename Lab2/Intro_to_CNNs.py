...
Original file is located at
    https://colab.research.google.com/drive/1eWrLnaT6Ngn11QaFABV_uVX1Ply4RcTB
...
cnn_model.compile(optimizer=tf.keras.optimizers.Adam(learning_rate=3e-4), loss='sparse_categorical_crossentropy', metrics=['accuracy']) # TODO
...
optimizer = tf.keras.optimizers.Adam(learning_rate=3e-4) # define our optimizer
